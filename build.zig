// tsundere-runtime build graph: wires the baka SDK, ELF loader, OS shim and runtime into the `tsundere` executable.
...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tsundere_runtime.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "baka", .module = baka_mod },
